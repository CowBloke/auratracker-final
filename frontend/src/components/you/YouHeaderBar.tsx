    ...
    <TooltipProvider delayDuration={80}>
      <div className="flex w-full items-center justify-between gap-3">
        ...
        <div className="flex shrink-0 items-center gap-2">
          ...
          <MoneyHistoryChip
            amount={user?.money}
            className="hidden items-center gap-2 rounded-full border border-border/60 bg-background/85 px-3.5 py-2 text-xs font-semibold text-emerald-600 shadow-sm dark:text-emerald-400 sm:flex"
          />
          <UserAccountMenu
            showLabel
