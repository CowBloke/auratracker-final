  ...
  (
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            "relative bg-sidebar [will-change:width]",
            collapsible === "icon"
              ? variant === "floating" || variant === "inset"
                ? "w-[calc(var(--sidebar-width-icon)_+_theme(spacing.4))]"
                : "w-[--sidebar-width-icon]"
              : "w-[--sidebar-width] transition-[width] duration-100 ease-out motion-reduce:transition-none",
        ...
        <div
          className={cn(
            "fixed inset-y-0 z-[60] hidden h-svh w-[--sidebar-width] bg-sidebar [will-change:left,right,width] transition-[left,right,width] duration-100 ease-out motion-reduce:transition-none md:flex",
            side === "left"
