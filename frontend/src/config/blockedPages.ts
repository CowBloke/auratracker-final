...
export const BLOCKABLE_PAGES: BlockablePage[] = [
  ...
  { key: 'game-market-room', path: '/games/salle-de-marche', label: 'Salle de marché', category: 'Jeux', description: 'Hub crypto centralisant Aura Coin, Aura Stable et Chaos Coin.' },
  { key: 'game-aura-coin', path: '/games/aura-coin', label: 'Aura Coin', category: 'Jeux', description: 'Terminal historique de trading Aura Coin.' },
  { key: 'game-stable-coin', path: '/games/stable-coin', label: 'Aura Stable', category: 'Jeux', description: 'Stable coin interne avec faible volatilite.' },
  { key: 'game-chaos-coin', path: '/games/chaos-coin', label: 'Chaos Coin', category: 'Jeux', description: 'Crypto tres instable avec variations agressives.' },
