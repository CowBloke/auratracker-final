...
export const BLOCKABLE_PAGES: BlockablePage[] = [
  ...
  { key: 'forum', path: '/forum', label: 'Forum', category: 'Communauté', description: 'Forum de discussion — parcourez les sujets et participez aux conversations.' },
  { key: 'messages', path: '/messages', label: 'Messages', category: 'Général', description: 'Messagerie directe entre joueurs.' },
  { key: 'marketplace', path: '/marketplace', label: 'Marketplace', category: 'Général', description: 'Place de marché entre joueurs — achetez et vendez des objets.' },
  { key: 'tutoriels', path: '/tutoriels', label: 'Tutoriels', category: 'Général', description: 'Guides et tutoriels pour apprendre à utiliser le site.' },
