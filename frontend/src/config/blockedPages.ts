...
export const BLOCKABLE_PAGES: BlockablePage[] = [
  ...
  { key: 'aura-scroll', path: '/aura-scroll', label: 'Aura Scroll', category: 'Communauté', description: 'Fil social vidéo court avec posts, likes, commentaires et partage de contenu.' },
