...
export const BLOCKABLE_PAGES: BlockablePage[] = [
  ...
  { key: 'game-market', path: '/market', label: 'Shop', category: 'Général', description: 'Boutique d\'objets, cosmétiques et améliorations.' },
  ...
  { key: 'pass', path: '/pass', label: 'Pass', category: 'Général', description: 'Pass de progression saisonnier avec récompenses échelonnées.' },
  ...
  { key: 'game-stack-tower', path: '/games/stack-tower', label: 'Stack Tower', category: 'Jeux', description: 'Empilez les blocs pour construire la tour la plus haute.' },
  ...
  { key: 'game-russian-roulette', path: '/games/russian-roulette', label: 'Russian Roulette', category: 'Jeux', description: 'Jeu de Roulette Russe — tentez votre chance.' },
  { key: 'game-jackpot-5', path: '/games/jackpot-5', label: 'Jackpot 5', category: 'Jeux', description: 'Tirage au sort — tentez de remporter le jackpot.' },
  { key: 'game-bomb-party', path: '/games/bomb-party', label: 'Bomb Party', category: 'Jeux', description: 'Jeu de mots multijoueur — trouvez des mots avant que la bombe explose.' },
  ...
  { key: 'game-ball-arena', path: '/games/ball-arena', label: 'Ball Arena', category: 'Jeux', description: 'Jeu d\'arène — faites tomber les adversaires hors du plateau.' },
  ...
  { key: 'clans', path: '/clans', label: 'Clans', category: 'Communauté', description: 'Système de clans — rejoignez ou créez votre guilde.' },
