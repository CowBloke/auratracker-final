...
export const BLOCKABLE_PAGES: BlockablePage[] = [
  ...
  { key: 'braquage-legal', path: '/braquage-legal', label: 'Le Braquage Légal', category: 'Communauté', description: 'Loterie à tickets avec propriétaire désigné, pool partagé et tirage aléatoire.' },
  { key: 'auravision', path: '/auravision', label: 'AuraVision', category: 'Communauté', description: 'Roulette video aleatoire entre joueurs avec filtres et effets en direct.' },
