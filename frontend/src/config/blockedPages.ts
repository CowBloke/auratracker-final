...
export const BLOCKABLE_PAGES: BlockablePage[] = [
  ...
  { key: 'braquage-legal', path: '/braquage-legal', label: 'Loto', category: 'Communauté', description: 'Loterie à tickets avec propriétaire désigné, pool partagé et tirage aléatoire.' },
