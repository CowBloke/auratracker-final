...
import { Play, RotateCcw, Trophy, X, Zap, Gauge, Mountain } from 'lucide-react';
        ...
        <Card className={cn(isFullscreen && 'hidden')}>
          ...
          <CardContent className="p-0">
            {leaderboard.length === 0 ? (
              ...
              <div className="divide-y divide-border/20 max-h-[540px] overflow-y-auto">
                  ...
                  >
                    ...
                    {user?.isAdmin && (
                      <Button
                        ...
                        className="h-6 w-6 shrink-0 text-destructive opacity-0 group-hover:opacity-100 hover:bg-destructive/10"
                      >
                        <X className="h-3 w-3" />
                      </Button>
                    )}
