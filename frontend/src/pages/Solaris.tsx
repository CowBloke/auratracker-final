      ...
      <Card className="border-border/40">
        <CardContent className={SPACING.SECTION_SPACING}>
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <Card className="border-border/40">
              <CardContent className="p-4">
                <p className={cn(TYPOGRAPHY.XS, "text-muted-foreground uppercase tracking-wide")}>Solde Solaris</p>
                <p className={cn(TYPOGRAPHY.H2, "tabular-nums")}>{solarisBalance.toFixed(4)} SOL</p>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <Card className="border-border/40">
              <CardContent className={SPACING.CARD_SPACING}>
                ...
                <div>
                  <label className={TYPOGRAPHY.XS}>Quantité (SOL)</label>
                  <div className="flex items-center gap-2 mt-1">
                    <Input
                      type="number"
                      value={sellAmount}
