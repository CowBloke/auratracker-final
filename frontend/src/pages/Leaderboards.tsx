...
import { X, Zap, DollarSign, TrendingUp, Gem, ArrowUp, Skull, Layers, Wind, Diamond, Timer, LayoutGrid, Sparkles, TrendingDown, Flame, Gamepad2, Hash, Target, TramFront, Bomb } from 'lucide-react';
...
type Category = 'aura' | 'money' | 'total_money' | 'auracoin' | 'doodle_jump' | 'doodle_jump_mort_subite' | 'game_2048' | 'flappy_bird' | 'solitaire' | 'racer' | 'tetris' | 'knife_hit' | 'subway_rush' | 'minesweeper' | 'casino' | 'casino_losses' | 'games_played' | 'bombparty';
...
const gameCategories: Category[] = ['doodle_jump', 'doodle_jump_mort_subite', 'game_2048', 'flappy_bird', 'solitaire', 'racer', 'tetris', 'knife_hit', 'subway_rush', 'minesweeper', 'casino', 'casino_losses', 'bombparty', 'games_played'];
...
const gamesCatalog = ['Doodle Jump', 'Démineur', '2048', 'Flappy Bird', 'Casino', 'Bomb Party', 'Poker', 'Petit Bac', 'Bataille Navale', 'Solitaire', 'Racer', 'Tetris', 'Knife Hit', 'Subway Rush', 'Polymarket'];
