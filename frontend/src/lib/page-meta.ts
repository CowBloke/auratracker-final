...
const STATIC_PAGE_META: Record<string, PageMeta> = {
  ...
  '/games/stable-coin': { title: 'Aura Stable', description: 'Stable coin avec volatilite reduite et spreads serres.' },
  '/games/chaos-coin': { title: 'Chaos Coin', description: 'Coin tres instable avec mouvements rapides et levier plus agressif.' },
  ...
  '/games/subway-surfers': { title: 'Subway Surfers Clone', description: 'Runner 3D inspiré du clone Unity, jouable depuis le hub.' },
