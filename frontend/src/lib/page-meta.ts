...
const STATIC_PAGE_META: Record<string, PageMeta> = {
  ...
  '/games/logic-lab': { title: 'Sudoku', description: 'Sudoku 9x9 avec grilles generees et plusieurs niveaux.' },
  ...
  '/games/clash': { title: 'Clash', description: 'Base isométrique, défenses, pillages et historique de raids.' },
