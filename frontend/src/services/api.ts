...
export const cemantixApi = {
  ...
  getStats: (userId: string) =>
    ...
    }>(`/cemantix/stats/${userId}`),
  getLeaderboard: (params?: { limit?: number; sortBy?: string }) =>
    api.get<{
      rankings: Array<{
        id: string;
        userId: string;
