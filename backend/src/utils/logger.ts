...
export type AdminAction =
  ...
  | 'extreme_aura_reset'
  | 'deploy_trigger'
  | 'polymarket_event_create'
  | 'polymarket_event_update'
  | 'polymarket_event_resolve'
  | 'polymarket_suggestion_approve'
  | 'polymarket_suggestion_reject'
  | 'gift_template_create'
  | 'gift_template_update'
  | 'gift_template_delete'
  | 'bombparty_prompts_recalculate'
  | 'update_popup_create'
  | 'update_popup_update'
  | 'update_popup_delete'
  | 'appeal_reject'
