...
export type SuggestionAction = 'suggestion_create' | 'suggestion_vote' | 'suggestion_comment' | 'suggestion_delete' | 'bug_report';
export type MarketplaceAction = 'item_purchase' | 'item_use' | 'item_create' | 'item_delete';
export type AdminAction = 'user_update' | 'user_delete' | 'user_approve' | 'user_reject' | 'inventory_add' | 'inventory_update' | 'inventory_remove' | 'chat_clear' | 'stats_delete';
