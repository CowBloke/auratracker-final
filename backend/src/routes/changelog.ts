...
const SEED_ENTRIES = [
  ...
  },
  {
    ...
    summary: "Les demandes de prêt peuvent maintenant inclure une hypothèque en aura et une lettre de motivation, les entreprises YOU peuvent ouvrir leur capital via des propositions d actionnariat, le parrainage arrive sur le dashboard avec un nouveau contrôle côté admin, les formations YOU affichent maintenant des avis commentés et les services de transfert perso sont utilisables depuis son propre business.",
    items: [
